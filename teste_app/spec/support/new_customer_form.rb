class NewCustomerForm
    # este arquivo não reconhece as gems e afins do rails, por isso precisa dos includes
    ...
    def login
        ...
        self # isso permite aquele encadeamento feito no customers_specs!
    end
    ...
    def fill_in_with(params = {})
        fill_in('Name', with: params.fetch(:name, Faker::Name.name)) #caso não passe o name, ele gera pelo faker
